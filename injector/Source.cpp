...
#include <iostream>
#include <string>
#include "../lol internal/XorCompileTime.h"
...
int main()
{
    const char* name = XorStr("League of legends.exe");

    DWORD pId = findPidByName(name);
    LPCSTR location = XorStr("C:\\Users\\tonka\\source\\repos\\lol internal\\Release\\lol internal.dll");
